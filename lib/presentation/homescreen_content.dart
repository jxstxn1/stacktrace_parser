    ...
    return Scaffold(
      body: Column(
        children: [
                                  ...
                                  children: <Widget>[
                                    ...
                                    TextButton(
                                      onPressed: () async {
                                        ...
                                        context
                                            .read<StacktraceBloc>()
                                            .add(StacktraceEvent.decryptStacktrace(_passwordController.value.text));
                                    ...
                                    children: <Widget>[
                                      ElevatedButton(
                                        onPressed: () {
                                          ...
                                          context
                                              .read<StacktraceBloc>()
                                              .add(StacktraceEvent.parseStacktrace(_stacktraceController.value.text));
                                        },
          ...
          TextButton(onPressed: () => Wiredash.of(context).show(), child: const Text('Send Feedback')),
          const Gap(5),
        ],
      ),
    );
